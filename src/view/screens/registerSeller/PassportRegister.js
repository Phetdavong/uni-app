...
import PassportRegisterViewModel from "../../../viewModel/registerSellerViewModels/PassportRegisterViewModel";
...
import { registerDocumentPassport } from "../../../stores/features/RegisterSlice";
import { useDispatch } from "react-redux";
import moment from "moment";

const PassportRegister = ({ navigation }) => {
  const {
    firstName,
    setFirstName,
    lastName,
  ...
  const handleRegisterDocumentPassport = () => {
    dispatch(
  ...
  const profile = galleryPhoto || cameraPhoto;
    ...
    <SafeAreaView style={{ flex: 1 }}>
      ...
      <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
        ...
        <View style={{ padding: 20, flex: 1 }}>
          ...
          >
            ການຢືນຢັນໂຕຕົນຜ່ານໜັງສືຜ່ານເເດນ
          </Text>
          <View style={{ flex: 1, marginTop: 10 }}>
            <View>
              ...
              <BorderTextInput
                ...
                placeholder={"ປ້ອນຊື່ຂອງທ່ານໃຫ້ຕົງກັບຊື່ໃນໜັງສືຜ່ານເເດນ"}
                onChangeText={(val) => {
                  setFirstName(val);
                }}
              />
            ...
            <View>
              ...
              <BorderTextInput
                ...
                keyboardType={"default"}
                placeholder={
                  "ປ້ອນນາມສະກຸນຂອງທ່ານໃຫ້ຕົງກັບນາມສະກຸນໃນໜັງສືຜ່ານເເດນ"
                }
                onChangeText={(val) => {
                  setLastName(val);
                }}
            ...
            <View>
              ...
              <BorderTextInput
                ...
                placeholder={"ປ້ອນໝາຍເລກຂອງໜັງສືຜ່ານເເດນ"}
                onChangeText={(val) => {
                  setNumberIdCard(val);
                }}
              />
            ...
            <View>
              ...
              <BorderTextInput
                value={authority}
                keyboardType={"default"}
                placeholder={"ໜັງສືຜ່ານເເດນອອກໂດຍໃຜ"}
                onChangeText={(val) => {
                  setAuthority(val);
                }}
              />
          ...
          <View className="mt-5">
            <RadiusButton
              onPress={() => {handleRegisterDocumentPassport();}}
              // disabled={true}
              text={"ບັນທຶກ"}
              textColor={"white"}
